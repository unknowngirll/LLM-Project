...
sys_prompt = Path("Prompts_v3/system_prompt.txt").read_text(encoding="utf-8").strip()
user_tmpl = Path("Prompts_v3/user_prompt.txt").read_text(encoding="utf-8").strip()
